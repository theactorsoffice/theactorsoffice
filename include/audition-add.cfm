  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        As the audition is a date in the past, do you want to add the Casting Director to a follow up system?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="submitForm('no')">No</button>
        <button type="button" class="btn btn-primary" onclick="submitForm('yes')">Yes</button>
      </div>
    </div>
  </div>
</div>
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="/include/audition-add2.cfm" class="parsley-examples" name="event-form" id="form-event" data-parsley-excluded="input[type=button], input[type=submit], input[type=reset], input[type=hidden], [disabled], :hidden" data-parsley-trigger="keyup" data-parsley-validate>
                        ...
                        <div class="row">
                            ...
                            <div id="hidden_divs">
                                <div class="form-group col-md-12">
                                    <label for="new_audLocation">Zoom Link (optional)</label>
