...
<div class="row">
    ...
    <div class="col-xl-6 col-lg-8 col-md-12">
        <div class="card">
                ...
                <cfform method="post" action="/include/note-update-aud2.cfm" class="parsley-examples" name="aud-form" id="form-aud" data-parsley-excluded="input[type=button], input[type=submit], input[type=reset], input[type=hidden], [disabled], :hidden" data-parsley-trigger="keyup" data-parsley-validate>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control" type="text" id="noteDetails"   name="noteDetails" placeholder="Write a note..." rows="1" required data-parsley-required data-parsley-error-message="Details are required"><cfoutput>#note.notedetails#</cfoutput></textarea>
         ...
         <div class="form-group col-md-12">
                 ...
                 <div id="snow-editor" style="height: 200px;"><cfoutput>#note.notedetailshtml#</cfoutput></div>
                        </div>
             ...
             <div class="form-group col-md-12">
                            <label for="audTypeName">Who can see your note?<span class="text-danger">*</span>    &nbsp;      <a class="primary" href=""  data-bs-toggle="modal" data-bs-target="#helpmodal">
  ...
  <div class="col-12">
      <textarea name="notetext" style="display:none" id="hiddenArea"></textarea></div>
                    <div class="row mt-2">
                        <div class="col-6">
