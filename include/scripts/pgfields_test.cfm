...
<h2><cfoutput>#pgname#</h2>
        <h3>#x.comptable#</h3></cfoutput>
        
            <CFINCLUDE template="/include/remote_load.cfm" /><cfquery datasource="#dsn#" name="y"      >
        SHOW full COLUMNS FROM #x.comptable# where 'field' not in ('recordname','IsDeleted')
        </cfquery> 
        ...
        <cfoutput>
         ...
         <cfif #find.recordcount# is "0" >   
                <cfif #fname# is not "IsDeleted" and #fname# is not "recordname" >
