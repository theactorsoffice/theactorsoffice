...
<cfqueryparam cfsqltype="CF_SQL_DATE" value="#new_holdStartDate#"  null="#NOT len(trim(new_holdStartDate))#" />,

<cfqueryparam cfsqltype="CF_SQL_DATE" value="#new_holdEndDate#"  null="#NOT len(trim(new_holdEndDate))#" />,
