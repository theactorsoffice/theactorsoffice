...
<cfhttp url="https://icon.horse/icon/#domain#?apikey=996ca328-b4b1-47a7-8d41-e5255525ab6b&fallback_bg=406e8e&size=small&ignore_other_sizes=false" method="get" getAsBinary="yes" result="icoResult"></cfhttp>
 ...
 <cfif icoResult.statusCode EQ "200 OK">
            ...
            <cfimage action="write" destination="#image_dir#\custom_#id#.png" source="#icoResult.filecontent#" format="png"  nameConflict="skip"></cfimage>
               <cfimage action="write" destination="#image_dir_dev#\custom_#id#.png" source="#icoResult.filecontent#" format="png"  nameConflict="skip"></cfimage>
                  <cfimage action="write" destination="#image_dir_uat#\custom_#id#.png" source="#icoResult.filecontent#" format="png"  nameConflict="skip"></cfimage>
            <!-- Update Record -->
