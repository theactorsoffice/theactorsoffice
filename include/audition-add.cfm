...
<cfquery name="cat" datasource="#dsn#">
    SELECT c.audcatid,c.audcatname,s.audsubcatid,s.audsubcatname FROM audcategories c INNER JOIN 
...
<cfquery name="audroletypes_sel" datasource="#dsn#">
    SELECT audroletypeid AS `id`,audroletype AS `name` FROM audroletypes where audcatid = #cat.audcatid# 
    AND isdeleted IS false
</cfquery>

<cfquery name="audtypes_sel" datasource="#dsn#">
    SELECT audtypeid as id,audtype as name,audcategories FROM audtypes WHERE isdeleted = 0 and 
    audcategories like '%#cat.audcatid#%' ORDER BY audtype
</cfquery>

<cfquery name="casting_types" datasource="#dsn#">
    SELECT tagid AS id,tagname AS name FROM tags_user WHERE iscasting IS TRUE AND userid = #userid# 
    AND isdeleted = 0 ORDER BY tagname
</cfquery>
...
<script>
    function submitForm(modalAnswer) {
    let form = document.getElementById("form-event");
    let input = document.createElement("input");
    input.type = "hidden";
    input.name = "modalAnswer";
    input.value = modalAnswer;
    ...
    let enteredDate = new Date(document.getElementById("new_audstartdate").value);
    ...
    let audtype = document.getElementById("audtypeid");
    audtype.addEventListener('change', function() {
    let selectedValue = audtype.options[audtype.selectedIndex].value;
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                As the audition is a date in the past, do you want to add the Casting Director to a 
                follow up system?
            </div>
    ...
    <div class="col-xl-12 col-lg-8 col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="/include/audition-add2.cfm" class="parsley-examples" 
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        <label for="new_projname">
                            Project Name (Title)
                            <span class="text-danger">
                                *
                            </span>
                        </label>
                        <input class="form-control" type="text" id="new_projname" autocomplete="off"
                               required data-parsley-required 
                               data-parsley-error-message="Project Name is required" 
                               name="new_projname" placeholder="Project Name">
                    </div>
                    
                    <div class="form-group col-md-12">
                        <label for="new_projDescription">
                        ...
                        <input class="form-control" type="text" id="new_projDescription" 
                               data-parsley-required data-parsley- name="new_projDescription" 
                    ...
                    <script>
                        ...
                        document.getElementById(divId).style.display = element.value == 2 ? 'block' 
                        : 'none';
                        }
                    </script>
                    ...
                    <script>
                        ...
                        document.getElementById(divId).style.display = element.value == 0 ? 'block' 
                        : 'none';
                        }
                    </script>
                    ...
                    <script>
                        ...
                        document.getElementById(divId).style.display = element.value == 23 ? 'none' 
                        : 'block';
                        }
                    </script>
                    ...
                    <div id="hidden_divs">
                        <div class="form-group col-md-12">
                            <label for="new_audLocation">
                                Zoom Link (optional)
                            </label>
                            
                            <input class="form-control" type="text" id="new_audLocation" 
                                   autocomplete="off" name="new_audLocation" placeholder="Zoom link">
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select id="audplatformid" name="new_audplatformid" class="form-control">
                                ...
                                <cfoutput query="audplatforms_sel">
                                    ...
                                    <option value="#audplatforms_sel.id#">
                                        #audplatforms_sel.name# 
                                    </option>
                    ...
                    <div class="form-group col-md-6 col-sm-12">
                        <label for="new_audrolename">
                            Role Name 
                            <span class="text-danger">
                                *
                            </span>
                        </label>
                        <input class="form-control" type="text" id="new_audrolename" 
                               autocomplete="off" required data-parsley-required 
                               data-parsley-error-message="Role Name is required" 
                               name="new_audrolename" placeholder="Role Name">
                    </div>
                    ...
                    <cfelse>
                        ...
                        <select id="new_audroletypeid" name="new_audroletypeid" class="form-control" 
                                data-parsley-required 
                                data-parsley-error-message="Role Type is required">
                            <option value="">
                                --
                            </option>
                            
                            <cfoutput query="audroletypes_sel">
                                <option value="#audroletypes_sel.id#">
                                    #audroletypes_sel.name#
                                </option>
                            </cfoutput>
                        </select>
                    </cfif>
                ...
                <div class="form-group col-md-12">
                    ...
                    <label for="new_contactid">
                        Casting Director 
                    </label>
                    
                    <select id="new_contactid" class="form-control" name="new_contactid" 
                            onchange="showDivssss('hidden_divssss', this)">
                        <option value="">
                            --
                        </option>
                        <option value="0">
                        ...
                        <cfoutput query="castingdirectors_sel">
                            <option value="#castingdirectors_sel.id#">
                                #castingdirectors_sel.name#
                            </option>
                        </cfoutput>
                    </select>
                </div>
                ...
                <div id="hidden_divssss">
                    ...
                    <div class="row">
                        ...
                        <fieldset>
                            ...
                            <legend>
                                Add New Casting Director
                            </legend>
                            
                            <div class="form-group col-md-6">
                            
                                <label for="cdfirstname">
                                    Casting Director - First Name
                                    <span class="text-danger">
                                        *
                                    </span>
                                </label>
                                
                                <input class="form-control" type="text" id="cdfirstname" 
                                       name="cdfirstname" 
                                       placeholder="Casting Director - First Name" required 
                                       data-parsley-required 
                                       data-parsley-error-message=">Casting Director - First Name is required">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <label for="cdlastname">
                                    Casting Director - Last Name
                                    <span class="text-danger">
                                        *
                                    </span>
                                </label>
                                
                                <input class="form-control" type="text" id="cdlastname" 
                                       name="cdlastname" placeholder="Casting Director - Last Name" 
                                       required data-parsley-required 
                                       data-parsley-error-message=">Casting Director - Last Name is required">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="cdtype" name="cdtype" class="form-control" 
                                        data-parsley-required 
                                        data-parsley-error-message="Casting Director Role is required">
                                    ...
                                    <cfoutput query="casting_types">
                                        ...
                                        <option value="#casting_types.name#">
                                            #casting_types.name#
                                        </option>
                ...
                <fieldset class="answer" id="hidedirectbooking">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <cfelse>
                            ...
                            <select id="audtypeid" name="new_audtypeid" class="form-control" 
                                    data-parsley-required 
                                    data-parsley-error-message="Type is required" 
                                    onchange="showDivs('hidden_divs', this); showDivss('hidden_divss', this); showdirectbooking('hidedirectbooking', this);">
                    ...
                    <div class="form-group col-md-6">
                        <label for="new_audstartdate">
                            Start Date / Due Date
                            <span class="text-danger">
                                *
                            </span>
                        </label>
                        <input id="new_audstartdate" class="form-control" autocomplete="off" 
                               name="new_audstartdate" type="date" data-parsley-required 
                               data-parsley-error-message="Start Date is required">
                    </div>
                    
                    <div class="form-group col-md-6">
                        <label for="new_audstartTime">
                            Start Time / Due Time
                            <span class="text-danger">
                                *
                            </span>
                        ...
                        <select class="form-control" name="new_audstartTime" autocomplete="off" 
                                id="new_audstartTime" data-parsley-required 
                    ...
                    <div class="form-group col-md-6">
                        <label for="new_audendtime">
                            Duration
                        </label>
                        <select class="form-control" name="new_durid" autocomplete="off" 
                                id="new_durid">
                    ...
                    <div id="hidden_divss">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input class="form-control" type="text" id="audlocname" 
                                       name="new_audlocname" placeholder="Location Name" required 
                                       data-parsley-required 
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input class="form-control" type="text" id="audlocadd1" 
                                       name="new_audlocadd1" placeholder="Address"/>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input class="form-control" type="text" id="audlocadd2" 
                                       name="new_audlocadd2" placeholder="APT 101"/>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" type="text" id="audcity" 
                                       name="new_audcity" placeholder="Enter City">
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" type="text" id="audzip" 
                                       name="new_audzip" placeholder="Enter Postal Code">
                            </div>
