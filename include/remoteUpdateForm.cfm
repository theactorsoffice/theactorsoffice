            ...
            <cfelseif #RPGUpdate.updatetype# is "textarea">
                ...
                <cfquery name="FindValue" datasource="#dsn#">
                    ...
                    Where #Fid# = #recid#
                        ...
                        <cfquery name="selects" datasource="#dsn#">
                            select #rpgupdate.fname# as value, recordname as text from #RPgupdate.tableSelect# 
...
<div style="margin-left:25px;">
                <label class="custom-control-label">
                    <input type="checkbox" class="custom-control-input" id="#RPGUpdate.fname#" value="1" name="new_#RPGUpdate.fname#" <Cfif #FindValue.fvalue# is "1">checked</cfif> >
                    <span class="custom-control-label" for="#RPGUpdate.fname#">#RPGUpdate.updatename#</span></label>
            </div>
</div>
         </Cfoutput>     
...
<div style="margin-left:25px;">
    ...
    <cfoutput>     select recordname as value, recordname as text from #RPgupdate.tableSelect# order by recordname</cfoutput><cfabort>
