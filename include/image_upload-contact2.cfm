...
<cfimage 
    ...
    action="write">
         ...
         <cfoutput>
                ...
                <cfif #isdefined('cookie.uploadDir_Contact')#>cookie.uploadDir_Contact: #cookie.uploadDir_Contact#<br /></cfif>
...
<cfmail from="support@theactorsoffice.com" to="kevinking7135@gmail.com" subject="#cookie.uploadDir_Contact#" type="HTML">
             <p>#diagnostics#</p>
